...
readonly counts_dir="data/gnomad/genes/${maf_label}"
readonly counts_prefix="gnomad.exomes.v4.0.genes.chr${chr}.counts.all.${maf_label}"
readonly out_dir="data/gnomad/hwe/genes/${maf_label}"
